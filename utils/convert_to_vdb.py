...
def create_vdb(
    ...
    density_grid = create_grid(
        background_value, dims, density_data, "density", "scalar"
    )
    ...
    temperature_grid = create_grid(
        background_value, dims, temperature_data, "temperature", "scalar"
    )
    ...
    print(
        "%s: %d grids, %d active voxels exported." % (vdb_filename, len(grids), nvoxels)
    )
