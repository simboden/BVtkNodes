...
class VTKParametricBohemianDome(Node, BVTK_Node):
    ...
    m_ClockwiseOrdering: bpy.props.BoolProperty(name='ClockwiseOrdering', default=True, update=BVTK_Node.outdate_vtk_status)
    m_DerivativesAvailable: bpy.props.BoolProperty(name='DerivativesAvailable', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinU: bpy.props.BoolProperty(name='JoinU', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinW: bpy.props.BoolProperty(name='JoinW', default=True, update=BVTK_Node.outdate_vtk_status)
    ...
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-3.141592653589793, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricBour(Node, BVTK_Node):
    ...
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricCatalanMinimal(Node, BVTK_Node):
    ...
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-12.566370614359172, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricEllipsoid(Node, BVTK_Node):
    ...
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_XRadius: bpy.props.FloatProperty(name='XRadius', default=1.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricEnneper(Node, BVTK_Node):
    ...
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=2.0, update=BVTK_Node.outdate_vtk_status)
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-2.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricHenneberg(Node, BVTK_Node):
    ...
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-1.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricKuen(Node, BVTK_Node):
    ...
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=3.141592653589793, update=BVTK_Node.outdate_vtk_status)
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-4.5, update=BVTK_Node.outdate_vtk_status)
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricMobius(Node, BVTK_Node):
    ...
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_Radius: bpy.props.FloatProperty(name='Radius', default=1.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricPseudosphere(Node, BVTK_Node):
    ...
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=3.141592653589793, update=BVTK_Node.outdate_vtk_status)
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-5.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-3.141592653589793, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricRandomHills(Node, BVTK_Node):
    ...
    m_AllowRandomGeneration: bpy.props.BoolProperty(name='AllowRandomGeneration', default=True, update=BVTK_Node.outdate_vtk_status)
    m_ClockwiseOrdering: bpy.props.BoolProperty(name='ClockwiseOrdering', default=True, update=BVTK_Node.outdate_vtk_status)
    m_DerivativesAvailable: bpy.props.BoolProperty(name='DerivativesAvailable', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinU: bpy.props.BoolProperty(name='JoinU', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True, update=BVTK_Node.outdate_vtk_status)
    ...
    m_HillAmplitude: bpy.props.FloatProperty(name='HillAmplitude', default=2.0, update=BVTK_Node.outdate_vtk_status)
    m_HillXVariance: bpy.props.FloatProperty(name='HillXVariance', default=2.5, update=BVTK_Node.outdate_vtk_status)
    m_HillYVariance: bpy.props.FloatProperty(name='HillYVariance', default=2.5, update=BVTK_Node.outdate_vtk_status)
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=10.0, update=BVTK_Node.outdate_vtk_status)
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=10.0, update=BVTK_Node.outdate_vtk_status)
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-10.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-10.0, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricSpline(Node, BVTK_Node):
    ...
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True, update=BVTK_Node.outdate_vtk_status)
    m_JoinW: bpy.props.BoolProperty(name='JoinW', default=True, update=BVTK_Node.outdate_vtk_status)
    m_ParameterizeByLength: bpy.props.BoolProperty(name='ParameterizeByLength', default=True, update=BVTK_Node.outdate_vtk_status)
    m_TwistU: bpy.props.BoolProperty(name='TwistU', default=True, update=BVTK_Node.outdate_vtk_status)
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True, update=BVTK_Node.outdate_vtk_status)
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True, update=BVTK_Node.outdate_vtk_status)
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status)
...
class VTKParametricSuperEllipsoid(Node, BVTK_Node):
    ...
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.5707963267948966, update=BVTK_Node.outdate_vtk_status)
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0, update=BVTK_Node.outdate_vtk_status)
    m_N1: bpy.props.FloatProperty(name='N1', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_N2: bpy.props.FloatProperty(name='N2', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_XRadius: bpy.props.FloatProperty(name='XRadius', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_YRadius: bpy.props.FloatProperty(name='YRadius', default=1.0, update=BVTK_Node.outdate_vtk_status)
    m_ZRadius: bpy.props.FloatProperty(name='ZRadius', default=1.0, update=BVTK_Node.outdate_vtk_status)
