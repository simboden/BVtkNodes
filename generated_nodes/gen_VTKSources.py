...
class VTKHyperTreeGridSource(Node, BVTK_Node):
    ...
    m_MaximumLevel: bpy.props.IntProperty(name='MaximumLevel', default=1, update=BVTK_Node.outdate_vtk_status)
...
class VTKSelectionSource(Node, BVTK_Node):
    ...
    m_ContentType: bpy.props.IntProperty(name='ContentType', default=4, update=BVTK_Node.outdate_vtk_status)
    m_FieldType: bpy.props.IntProperty(name='FieldType', default=0, update=BVTK_Node.outdate_vtk_status)
    m_HierarchicalIndex: bpy.props.IntProperty(name='HierarchicalIndex', default=-1, update=BVTK_Node.outdate_vtk_status)
    m_HierarchicalLevel: bpy.props.IntProperty(name='HierarchicalLevel', default=-1, update=BVTK_Node.outdate_vtk_status)
